...
{
    /// <inheritdoc />
    public partial class CartItemVariantV12 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CartItemVariants_ProductVariants_VariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemVariants_CartItemId",
                table: "CartItemVariants",
                column: "CartItemId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemVariants_VariantId",
                table: "CartItemVariants",
                column: "VariantId");
        }
